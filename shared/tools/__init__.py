...
────────────────────
  ...
  get_oncology_reports       Oncology DiagnosticReports (Biopsy, etc.)
  get_molecular_variants     Genomic observations (markers)
  match_clinical_trials      Precision trial matching logic
